...
This docs site provides deeper guides. The canonical quickstart and package summary live in [README](https://github.com/vedaterenoglu/post-meta-extractor/blob/main/README.md).
...
- Review [AI Adapters Guide](../guides/ai-adapters.md)
- See [Core API Reference](../reference/core-api.md)
